...
# ==============================================================================
# Database Migrations Script - ide-orchestrator
# ==============================================================================
# Runs database migrations for ide-orchestrator service
...
main() {
    ...
    log_success "Database migrations completed for ide-orchestrator"
}
